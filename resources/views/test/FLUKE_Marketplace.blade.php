...
@php
  ...
  $desc_serp = $seo['desc_serp']
    ?? 'FLUKE ของแท้จากศูนย์ไทย — คาลิเบรตมาตรฐาน | โทร 066-097-5697 | LINE @hikaridenki';

  // Social (ยาว ใส่ช่องทางครบ)
  $desc_social = $seo['desc_social']
    ?? 'ศูนย์รวม FLUKE ของแท้จากศูนย์ไทย — คาลิเบรตมาตรฐานสากล | สอบถาม 066-097-5697 (คุณผาบุ้ง) | info@hikaripower.com | LINE @hikaridenki';
...
<body>
  ...
  (function () {
    ...
    // // ถ้าต้องการให้เคารพ prefers-reduced-motion ให้ปลดคอมเมนต์
