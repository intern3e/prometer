      ...
      <section class="bg-[var(--bg)] flex items-center justify-center px-4 py-10 md:py-14">
        <div class="w-full max-w-[520px]">
          ...
          <div class="card p-5 md:p-6">
            ...
            <form id="loginForm" class="space-y-4" method="POST" action="{{ route('auth.login') }}" novalidate>
                @csrf

                {{-- แจ้ง error ระดับบน (ถ้ามี) --}}
                @if ($errors->any())
...
@endif
            ...
            <p class="text-center text-sm text-gray-600 mt-5">
              ...
              <a href="{{ route('Sign_up') }}" class="text-orange-600 font-semibold hover:underline" data-i18n="register_now">ลงทะเบียนตอนนี้</a>
            </p>
          </div>
