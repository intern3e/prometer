  ...
  <section class="container-outer mx-auto section-pad mt-3 md:mt-5 grid grid-cols-1 md:grid-cols-12 gap-4">
    ...
    <aside class="hidden md:block md:col-span-3 card p-2 left-cat">
      <ul class="text-sm divide-y">
        <li><a href="<?php echo e(route('product.category', ['slug' => 'ClampMeter1'])); ?>" class="px-3 py-2" data-i18n="left_c1">แคลมป์มิเตอร์</a></li>
        <li><a href="<?php echo e(route('product.category', ['slug' => 'Multimeters'])); ?>"  class="px-3 py-2" data-i18n="left_c2">มัลติมิเตอร์</a></li>
        <li><a href="<?php echo e(route('product.category', ['slug' => 'ElectricalTesters'])); ?>"  class="px-3 py-2" data-i18n="left_c3">เครื่องตรวจไฟ/ทดสอบไฟฟ้า</a></li>
        <li><a href="<?php echo e(route('product.category', ['slug' => 'Thermography'])); ?>"  class="px-3 py-2" data-i18n="left_c4">กล้องถ่ายภาพความร้อน</a></li>
        <li><a href="<?php echo e(route('product.category', ['slug' => 'InsulationTesters'])); ?>"  class="px-3 py-2" data-i18n="left_c5">เครื่องวัดฉนวน</a></li>
        <li><a href="<?php echo e(route('product.category', ['slug' => 'PowerQuality'])); ?>"  class="px-3 py-2" data-i18n="left_c6">คุณภาพไฟฟ้า</a></li>
        <li><a href="<?php echo e(route('product.category', ['slug' => 'LoopCalibrators'])); ?>"  class="px-3 py-2" data-i18n="left_c7">เครื่องสอบเทียบ</a></li>
        <li><a href="<?php echo e(route('product.category', ['slug' => 'Accessories'])); ?>"  class="px-3 py-2" data-i18n="left_c8">อุปกรณ์เสริม</a></li>
      </ul>
    </aside>
...
<section class="container-outer mx-auto section-pad mt-6">
  <div class="card p-3 md:p-4">
    <div class="flex items-center justify-between mb-3">
      ...
      <a href="<?php echo e(route('product.index')); ?>">ดูทั้งหมด</a>
    </div>
  ...
  <section class="container-outer mx-auto section-pad mt-10">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          <a href="<?php echo e(route('product.category', ['slug' => 'ClampMeter1'])); ?>"class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/clamp-meters.jpg')); ?>" alt="Clamp Meter" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_1">แคลมป์มิเตอร์</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'ElectricalTesters'])); ?>"class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/electrical-testers.jpg')); ?>" alt="Electrical Testers" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_2">เครื่องทดสอบไฟฟ้า</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'GroundResistance'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/ground-resistance.jpg')); ?>" alt="Ground Resistance" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_3">เครื่องทดสอบสายดิน</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'InsulationTesters'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/insulation-testers.jpg')); ?>" alt="Insulation Testers" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_4">เครื่องวัดฉนวน</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'Multimeters'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/multimeters.jpg')); ?>" alt="Multimeters" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_5">มัลติมิเตอร์</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'PowerQuality'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/power-quality.jpg')); ?>" alt="Power Quality" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_6">คุณภาพไฟฟ้า</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'PreventativeMaintenance'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/preventative-maintenance.jpg')); ?>" alt="Preventative Maintenance" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_7">การบำรุงรักษา</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'ProcessTools'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/process-tools.jpg')); ?>" alt="Process Tools" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_8">เทอร์โมกราฟี</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'ScopeMeters'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/scope-meters.jpg')); ?>" alt="Scope Meters" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_9">เครื่องวัดสโคป</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'Temperature'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/temperature.jpg')); ?>" alt="Temperature Tools" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_10">เครื่องมือวัดอุณหภูมิ</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'Thermography'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/thermography.jpg')); ?>" alt="Thermography" class="w-full h-40 md:h-44 object-cover">
            <div class="cat-caption"><p data-i18n="cat_g_11">กล้องถ่ายภาพความร้อน</p></div>
          </div>
        </a>
        <a href="<?php echo e(route('product.category', ['slug' => 'MiscTools'])); ?>" class="block lift">
          <div class="card overflow-hidden cat-card">
            <img src="<?php echo e(asset('storage/misc-tools.jpg')); ?>" alt="Misc Tools" class="w-full h-40 md:h-44 object-cover">
...
<script>
  window.FLASH_DEALS = <?php echo json_encode($flashDeals ?? [], 15, 512) ?>;
  window.PRODUCTS    = <?php echo json_encode($products ?? [], 15, 512) ?>;
</script>
...
<?php /**PATH C:\xampp\htdocs\tool\resources\views/test/FLUKE_Marketplace.blade.php ENDPATH**/ ?>