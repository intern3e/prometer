...
<nav class="bg-white border-b sticky top-0 z-[40]" role="navigation" aria-label="Primary">
  <div class="container-outer mx-auto section-pad py-3 md:py-4 flex items-center gap-2 md:gap-6">
        ...
        <div id="megaMenu"
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              <li><a href="<?php echo e(route('product.category', ['slug' => 'ClampMeter1'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_1">แคลมป์มิเตอร์</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'Multimeters'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_2">มัลติมิเตอร์</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'ElectricalTesters'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_3">เครื่องทดสอบไฟฟ้า</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'InsulationTesters'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_4">เครื่องวัดฉนวน</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'Thermography'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_5">กล้องถ่ายภาพความร้อน</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              <li><a href="<?php echo e(route('product.category', ['slug' => 'LoopCalibrators'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_p1">เครื่องสอบเทียบลูป</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'CalibrationTools'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_p2">เครื่องสอบเทียบความดัน</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'Temperature'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_p3">เครื่องสอบเทียบอุณหภูมิ</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'ProcessCalibrators'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_p4">เครื่องสอบเทียบกระบวนการ</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              <li><a href="<?php echo e(route('product.category', ['slug' => 'TestLeadsProbes'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_a1">สายวัดและโพรบ</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'BatteriesChargers'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_a2">แบตเตอรี่และชาร์จ</a></li>
              <li><a href="<?php echo e(route('product.category', ['slug' => 'ToolCases'])); ?>" class="block hover:text-[var(--brand)] hover:pl-1 transition" data-i18n="cat_left_a3">กล่องเก็บเครื่องมือ</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <a href="<?php echo e(url('cart')); ?>" class="nav-cart relative text-gray-700 hover:text-[var(--brand)] ml-1" aria-label="cart">
      <i class="bi bi-cart text-2xl"></i>
      <span id="cartCountDb"
            data-count="<?php echo e($cartCount); ?>"
...
<?php /**PATH C:\xampp\htdocs\tool\resources\views/test/header-nav.blade.php ENDPATH**/ ?>