...
<head>
  ...
  <title>FLUKE | ElectricalTesters</title>
...
<script>
  ...
  function applyI18n(lang){
    ...
    document.title = (lang === 'ไทย')
      ? 'FLUKE | เครื่องทดสอบไฟฟ้า'
      : 'FLUKE | ElectricalTesters';
...
(function(){
  ...
  function isClampCategory(cat){
    ...
    return c.includes('electrical testers and voltage continuity testers'.toLowerCase());
  }
...
<?php /**PATH C:\xampp\htdocs\tool\resources\views/Product/ElectricalTesters.blade.php ENDPATH**/ ?>