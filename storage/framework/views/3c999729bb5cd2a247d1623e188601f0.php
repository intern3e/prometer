  ...
  <section class="container-outer mx-auto section-pad mt-6">
    <div class="flex items-center justify-between mb-3">
      <h3 class="text-lg md:text-xl font-bold">
        <?php echo e($mode === 'grouped' ? ($groupLabelTh ?? 'หมวดหมู่') : 'สินค้าทั้งหมด'); ?>
    ...
    <?php if($mode === 'grouped'): ?>
      ...
      <div id="productGrid" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
        <?php $__empty_1 = true; $__currentLoopData = $flat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php
            $img = $p->pic;
          ...
          <a class="block hover:shadow transition-fast"
             href="<?php echo e(route('product.detail', $p->iditem)); ?>"
             data-name="<?php echo e(\Illuminate\Support\Str::lower($p->name)); ?>">
            <div class="border rounded-lg overflow-hidden bg-white">
              <div class="aspect-square bg-gray-50">
                <img class="block w-full h-full object-cover object-center"
                     src="<?php echo e($src); ?>" alt="<?php echo e($p->name); ?>"
                     loading="lazy" decoding="async">
              </div>
            </div>
            <div class="p-2">
              <p class="text-xs text-gray-700 line-clamp-2"><?php echo e($p->name); ?></p>
              <p class="text-[var(--brand)] font-semibold mt-1 price-i18n"
                 data-price-thb="<?php echo e($p->webpriceTHB); ?>"><?php echo e($fallback); ?></p>
            </div>
          </a>
      ...
      <nav class="hidden md:flex justify-center mt-6">
        <ul class="inline-flex items-center gap-1 text-sm">
          ...
          <?php if(!$items->onFirstPage()): ?>
            <li><a class="<?php echo e($chip); ?>" href="<?php echo e($items->url(1)); ?>" aria-label="First">«</a></li>
            <li><a class="<?php echo e($chip); ?>" href="<?php echo e($items->previousPageUrl()); ?>" aria-label="Previous">‹</a></li>
          <?php endif; ?>

          
          <?php if($start > 1): ?>
            <li><a class="<?php echo e($chip); ?>" href="<?php echo e($items->url(1)); ?>">1</a></li>
            <?php if($start > 2): ?>
          ...
          <?php for($i = $start; $i <= $end; $i++): ?>
            <li>
              <?php if($i == $current): ?>
                <span class="<?php echo e($chipActive); ?>"><?php echo e($i); ?></span>
              <?php else: ?>
                <a class="<?php echo e($chip); ?>" href="<?php echo e($items->url($i)); ?>"><?php echo e($i); ?></a>
              <?php endif; ?>
            </li>
          <?php endfor; ?>
          ...
          <?php if($end < $last): ?>
            <?php if($end < $last - 1): ?>
              <li><span class="px-2">…</span></li>
            <?php endif; ?>
            <li><a class="<?php echo e($chip); ?>" href="<?php echo e($items->url($last)); ?>"><?php echo e($last); ?></a></li>
          <?php endif; ?>

          
          <?php if($items->hasMorePages()): ?>
            <li><a class="<?php echo e($chip); ?>" href="<?php echo e($items->nextPageUrl()); ?>" aria-label="Next">›</a></li>
            <li><a class="<?php echo e($chip); ?>" href="<?php echo e($items->url($last)); ?>" aria-label="Last">»</a></li>
          <?php endif; ?>
        </ul>
      </nav>
      ...
      <nav class="md:hidden mt-6">
        <div class="mx-auto w-full max-w-[360px] px-3">
          <ul class="grid grid-cols-5 items-center gap-1 p-1 rounded-full border bg-white shadow-sm select-none">
            ...
            <li>
              <?php if(!$items->onFirstPage()): ?>
                <a class="<?php echo e($chip); ?>" href="<?php echo e($items->previousPageUrl()); ?>" aria-label="Previous">‹</a>
              <?php else: ?>
                <span class="<?php echo e($chip); ?> opacity-40 pointer-events-none cursor-default">‹</span>
              <?php endif; ?>
            </li>

            
            <?php for($i = $mStart; $i <= $mEnd; $i++): ?>
              <li>
                <?php if($i == $current): ?>
                  <span class="<?php echo e($chipActive); ?>"><?php echo e($i); ?></span>
                <?php else: ?>
            ...
            <li>
              <?php if($items->hasMorePages()): ?>
                <a class="<?php echo e($chip); ?>" href="<?php echo e($items->nextPageUrl()); ?>" aria-label="Next">›</a>
              <?php else: ?>
                <span class="<?php echo e($chip); ?> opacity-40 pointer-events-none cursor-default">›</span>
              <?php endif; ?>
            </li>
...
<?php /**PATH C:\xampp\htdocs\tool\resources\views/Product/showproduct.blade.php ENDPATH**/ ?>